...
export default function Header() {
  ...
  return (
    <header className="bg-white border-b border-gray-200">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 pl-0 lg:px-8" aria-label="Global">
        <div className="flex">
        ...
        <div className="flex lg:gap-x-12">
          <Link href="/solutions/investment-teams" className="text-sm font-semibold leading-6 text-gray-700 hover:text-blue-900">
            Investment Management
          </Link>
          <Link href="/solutions/front-office" className="text-sm font-semibold leading-6 text-gray-700 hover:text-blue-900">
            Wealth Advisory
          </Link>
          <Link href="/solutions/secondary-market" className="text-sm font-semibold leading-6 text-gray-700 hover:text-blue-900">
            Client Solutions
          </Link>
